...
def load_data():
    ...
    #TRAIN_IMAGE_DATA = np.concatenate((TRAIN_BEE, TRAIN_NO_BEE, TRAIN_BEE, TRAIN_BEE, TRAIN_BEE, TRAIN_BEE, TRAIN_BEE, TRAIN_BEE, TRAIN_BEE, TRAIN_BEE, TRAIN_BEE, TRAIN_BEE, TRAIN_BEE))
    TRAIN_TARGET = np.concatenate((TRAIN_TARGET_BEE, TRAIN_TARGET_NO_BEE))
    #TRAIN_TARGET = np.concatenate((TRAIN_TARGET_BEE, TRAIN_TARGET_NO_BEE, TRAIN_TARGET_BEE, TRAIN_TARGET_BEE, TRAIN_TARGET_BEE, TRAIN_TARGET_BEE, TRAIN_TARGET_BEE, TRAIN_TARGET_BEE, TRAIN_TARGET_BEE, TRAIN_TARGET_BEE, TRAIN_TARGET_BEE, TRAIN_TARGET_BEE, TRAIN_TARGET_BEE))
...
def load_data_wrapper():
    ...
    test_bee_data = zip(test_bee_inputs, te_bee[1])

    test_no_bee_inputs = [np.reshape(x, (1024, 1)) for x in te_no_bee[0]]
    test_no_bee_data = zip(test_no_bee_inputs, te_no_bee[1])
